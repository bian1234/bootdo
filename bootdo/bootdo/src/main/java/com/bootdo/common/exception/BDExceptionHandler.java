...
//    public Rest handleBDException(BDException e) {
...
//        logger.error(e.getMessage(), e);
//        return Rest.error("数据库中已存在该记录");
//    }
//
//    @ExceptionHandler(org.springframework.web.servlet.NoHandlerFoundException.class)
//    public Rest noHandlerFoundException(org.springframework.web.servlet.NoHandlerFoundException e) {
//        logger.error(e.getMessage(), e);
//        return Rest.error(404, "没找找到页面");
//    }
    ...
    public Object handleException(Exception e, HttpServletRequest request) {
        ...
        logger.error(e.getMessage(), e);
        if (HttpServletUtils.jsAjax(request)) {
            return Rest.error(500, "服务器错误，请联系管理员");
        }
